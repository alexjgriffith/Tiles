...
start_link()->
    ...
    register(erws_id_proc,PID).

get_id()->
    gen_server:call(erws_id_proc,{id,""}).

get_id(Req)->
    gen_server:call(erws_id_proc,{id,Req}).

list_ids()->
    gen_server:call(erws_id_proc,list).

stop()->
    gen_server:cast(erws_id_proc,stop).
